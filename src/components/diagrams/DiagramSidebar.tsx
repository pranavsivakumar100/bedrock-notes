...
const DiagramSidebar: React.FC<DiagramSidebarProps> = ({ 
  ...
  return (
    <ResizablePanel minSize={15} maxSize={40} defaultSize={20} className="h-full bg-background">
      <div className="w-full border-r border-border/40 flex flex-col h-full bg-background">
